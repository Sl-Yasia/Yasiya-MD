...
module.exports = {
  ...
  WELCOME_MSG: process.env.MESSAGE_MEM.WELCOME_MSG  === "" ? "Hi @user Welcome to @gname" : process.env.MESSAGE_MEM.WELCOME_MSG,
  GOODBYE_MSG: process.env.MESSAGE_MEM.GOODBYE_MSG  === "" ? "Hi @user It was Nice Seeing you" : process.env.MESSAGE_MEM.GOODBYE_MSG,
  ...
  ALIVE: process.env.MESSAGE_MEM.ALIVE  === "" ? "```I am active```" : process.env.MESSAGE_MEM.ALIVE,
